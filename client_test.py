...
#message generator
payload1="146ae5b084f930ea54fae5b171d87cb9-John-5-Andrew"#id,sender,value,receiver
...
mine(ip, port, privateKey, str(payload1), "146ae5b084f930ea54fae5b171d87cb9", "John", "5", "Andrew")
input("Press enter to mine...")
mine(ip, port, privateKey, str(payload2), "2a175d779041fc9588e8d5a793301824", "Andrew", "260", "Mark")
input("Press enter to mine...")
mine(ip, port, privateKey, str(payload3), "9354aa7d41de92df316845bee0d1e316", "Andrew", "321", "John")
input("Press enter to mine...")
mine(ip, port, privateKey, str(payload4), "5c2351993d8e607e5e3ddb6eeacb2079", "Juliette", "5", "Steven")
input("Press enter to mine...")
mine(ip, port, privateKey, str(payload1), "146ae5b084f930ea54fae5b171d87cb9", "John", "5", "Andrew")
